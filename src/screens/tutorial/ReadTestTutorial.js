...
const ReadTestTutorial = ({ navigation }) => {
    ...
    const menuList = [
        ...
        { 'name': '시험보기', speech: () => speech('시험보기'), action: () => navigation.navigate('ReadTestPractice', { category: category, brailleSymbols: symbols, brailleList: brailleList }) },
    ];
